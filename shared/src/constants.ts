...
export const developmentPublicPath = path.join(
  frontendDevelopmentPath,
  "public"
);
export const productionPublicPath = path.join(frontendProductionPath, "");

export const isDevMode = process.env.NODE_DEV?.toLowerCase() === "true";
...
export const publicPath = isDevMode
  ? developmentPublicPath
  : productionPublicPath;
export const frontendPath = isDevMode
  ? frontendDevelopmentPath
